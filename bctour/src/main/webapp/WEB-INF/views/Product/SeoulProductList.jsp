                        ...
                        <div class="product">
                            ...
                            <ul class="list">
                                <li class="pd_list">
                                    ...
                                    <div class="pd_img">
                                        <a href="<c:url value='/product'/>?pd_num=${list.pd_num}"><c:if test="${list.pd_img ==null}"><img src="/bctour/resources/img/noImg.jpg" style="width:200px; height:200px;"></c:if>
                                        <c:if test="${list.pd_img !=null}"><img src="/bctour/resources/img/${list.pd_img}" style="width:200px; height:200px;"></c:if></a>
                                    </div>
                                    <div class="pd_text">
                                        <div class="tag">
				...
				$(".pd_wish").on('click', function() {
				      if ( $(this).prop('checked') ) {
				        ...
				        $.ajax({
				            ...
				            url : "/bctour/addWish?pd_num="+$(this).attr('data-num'),      // 컨트롤러에서 대기중인 URL 주소이다.
				        ...
				        $.ajax({
				            type : "Post",            // HTTP method type(GET, POST) 형식이다.
				            url : "/bctour/delWish?pd_num="+$(this).attr('data-num'),      // 컨트롤러에서 대기중인 URL 주소이다.
				            headers: {"content-type" : "application/json"}, // 보내는 데이터 타입명시
				            data : JSON.stringify(params), // 전달 데이터// Json 형식의 데이터이다.
				            success : function(res){ // 비동기통신의 성공일경우 success콜백으로 들어옵니다. 'res'는 응답받은 데이터이다.
				            	location.reload();
