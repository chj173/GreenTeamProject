						...
						<div style="display:flex; text-align:left; align-items:center;">
                            ...
                            <div class="pd_img">
                            	<a href="<c:url value='/product'/>?pd_num=${list.pd_num}">
                            		<c:if test="${list.pd_img ==null}"><img src="/bctour/resources/img/noImg.jpg" style="width:200px; height:200px;"></c:if>
                                	<c:if test="${list.pd_img !=null}"><img src="/bctour/resources/img/${list.pd_img}" style="width:200px; height:200px;"></c:if>
                                </a>
                            </div>
                            <div class="pd_text">
                                <div class="tag">
	...
	<script>
		...
		$("#writecommbtn").click(function(){
            ...
            $.ajax({
                ...
                url : "/bctour/board/read_2",      // 컨트롤러에서 대기중인 URL 주소이다.
