...
<body>
        ...
        <script>
        	...
        	document.getElementById("tl1").innerHTML='<img src="/bctour/resources/img/noImg.jpg">';
        	}
            ...
            document.getElementById("tl2").innerHTML='<img src="/bctour/resources/img/noImg.jpg">';
            }
            ...
            document.getElementById("tl3").innerHTML='<img src="/bctour/resources/img/noImg.jpg">';
            }
        </script>
</body>
</html>