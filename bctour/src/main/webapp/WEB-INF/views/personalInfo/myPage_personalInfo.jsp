      ...
      $("#infodel").click(function(){
    	  $.ajax({
    		  ...
    		  success : function(result) {
    			  alert("회원탈퇴가 완료되었습니다.");
    			  location.href = "/bctour/logIn/logIn";
    		  },
      ...
      $("#pwdBtn").click(function(){
    	 ...
    	 $("#pwdBtn2").toggle();
      	...
      	$("#pwdBtn2").click(function() {
      		$.ajax({
      			type:'PATCH',
      			url: '/bctour/myPage/modifyPwd?pwd=' + pwd.val(),
      			beforeSend : function(xhr) {
      				if(pwd.val().length == 0) {
      					alert("비밀번호를 입력해주세요.");
      					pwd.focus();
      ...
      $("#emailBtn").click(function(){
      	...
      	$("#emailBtn2").click(function() {
        	var valid = new RegExp('^[a-zA-Z0-9+-\_.]+@[a-zA-Z0-9-]+\.[a-zA-Z0-9-.]+$');
      		$.ajax({
      			type:'PATCH',
      			url: '/bctour/myPage/modifyEmail?email=' + email.val(),
      			beforeSend : function(xhr) {
     ...
     // 전화번호 수정
        ...
        $("#telBtn").click(function(){
       	...
       	$("#telBtn2").click(function() {
       		$.ajax({
       			type:'PATCH',
       			url: '/bctour/myPage/modifyTel?tel=' + tel.val(),
       			beforeSend : function(xhr) {
       				if(tel.val().length == 0) {
       					alert("번호를 입력해주세요.");
       					tel.focus();
