...
import com.greenart.bctour.PageHandlerAndSearchCondition.ProductPageHandler;
...
import com.greenart.bctour.QuestionsAndAnswers.AnswerDto;
import com.greenart.bctour.QuestionsAndAnswers.QuestionsDao;
import com.greenart.bctour.QuestionsAndAnswers.QuestionsDto;
import com.greenart.bctour.QuestionsAndAnswers.QuestionsService;
import com.greenart.bctour.Reservation.ReservationDao;
import com.greenart.bctour.Reservation.ReservationDto;
import com.greenart.bctour.Reservation.ReservationService;
import com.greenart.bctour.User.BCUserDao;
import com.greenart.bctour.User.BCUserDto;
import com.greenart.bctour.WishList.WishDao;
import com.greenart.bctour.WishList.WishDto;
import com.greenart.bctour.WishList.WishService;
...
public class MyPageController {
	...
	public String modifyTel(HttpSession session, String tel) throws Exception{
			String id = (String)session.getAttribute("id");
			BCUserDto user = userDao.selectUser(id);
			if(tel.equals(user.getTel())) throw new Exception("번호�? ?��치함");
			if(tel.length() < 13) throw new Exception("길이�? �?족함");
